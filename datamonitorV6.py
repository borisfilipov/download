...
def create_synthetics(config_data):
    ...
    try:
        ...
        if df is None:
            print("Error: 'synthetics' sheet not found in Excel input")
            return
...
if __name__ == "__main__":
    ...
    parser.add_argument("--command", type=str, help="Command to execute: validate, create, delete, update, createsynthetics, deletesynthetics, updatesynthetics", required=True)
    args = parser.parse_args()
    command = args.command

    if command == "validate":
        validate_connection()
    elif command in {"check", "create", "update", "delete", "createsynthetics", "deletesynthetics", "updatesynthetics"}:
